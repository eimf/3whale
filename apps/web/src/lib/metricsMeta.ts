...
export const metricsMeta: Record<DashboardMetricKey, MetricMeta> = {
  ...
  returningCustomers: {
    ...
    tooltipDescriptionKey: "metrics.tooltips.returningCustomers.description",
  ...
  newCustomerRevenue: {
    ...
    tooltipDescriptionKey: "metrics.tooltips.newCustomerRevenue.description",
  },
  returningCustomerRevenue: {
    titleKey: "metrics.returningCustomerRevenue",
    tooltipDescriptionKey: "metrics.tooltips.returningCustomerRevenue.description",
  },
  discounts: {
