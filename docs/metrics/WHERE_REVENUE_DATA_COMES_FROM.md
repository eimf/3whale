...
| **Timezone wrong**      | If `shop_config.timezone_iana` is not set (e.g. UTC or default), “today” is the wrong set of orders.                                                                                                                             | Run `POST /internal/bootstrap`; timezone and currency are fetched from the Shopify API.                                                   |
