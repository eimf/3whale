...
describe("parseLocalDateRangeToUtc", () => {
    it("2026-02-28 in Mexico maps exactly to that local day boundaries in UTC", () => {
        const { startUtc, endUtc } = parseLocalDateRangeToUtc(
            "2026-02-28",
            "2026-02-28",
            MEXICO_TZ,
        );
        expect(startUtc.toISOString()).toBe("2026-02-28T06:00:00.000Z");
        expect(endUtc.toISOString()).toBe("2026-03-01T05:59:59.999Z");
    });
