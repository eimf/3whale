...
import { computeIncomeComponents, shouldExcludeOrderV1 } from "../../../metrics/computeIncomeComponents.js";
...
const orderFixture = {
  ...
  cancelledAt: null,
  test: false,
  currentSubtotalPriceSet: { shopMoney: { amount: "1000.00", currencyCode: "MXN" } },
  currentShippingPriceSet: { shopMoney: { amount: "100.00", currencyCode: "MXN" } },
  currentTotalTaxSet: { shopMoney: { amount: "160.00", currencyCode: "MXN" } },
  currentTotalDiscountsSet: { shopMoney: { amount: "0.00", currencyCode: "MXN" } },
  refunds: { nodes: [] },
};
